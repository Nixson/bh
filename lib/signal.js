...
*/
			...
			for(st in actions){
				...
				switch(actions[st][0]){
					case "wait":
							console.log(actions[st],_this.gData.validator.isInt(actions[st][1]));
							if(_this.gData.validator.isInt(actions[st][1])){
								var timeout = parseInt(actions[st][1]);
								isBreak = true;
								actions.splice(0, st);
								console.log("timeout",timeout,actions);
								setTimeout(function(){
