...
module.exports = function(gData){
	return {
		...
		code: function(section,callback){
			var _this = this;
		...
		loadInfo: function(section,callback){
			var _this = this;
			var inText = 'var bhelpSrvAddress="https://static.bhelp.com/main.js", bhelpSrvVersion='+_this.gData.sections[section].version+";\n";
			fs.readFile(__dirname+'/../js/load.js',"utf8", function (err, data) {
				callback(inText+data,200);
			});
		}
	}
}