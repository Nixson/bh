...
module.exports = function(gData){
	return {
		...
		loadInfo: function(section,locale,callback){
			...
			var ret = {};
			ret.off_yes = infoLocal.off_yes;
			ret.off_no = infoLocal.off_no;
			ret.off_atitle = infoLocal.off_atitle;
			ret.off_ok = infoLocal.off_ok;
			ret.bhelp = infoLocal.bhelp;
			ret.off_title = infoLocal.off_title;
			ret.off_name = infoLocal.off_name;

			ret.off_phone = infoLocal.off_phone;
			ret.off_message = infoLocal.off_message;
			ret.off_btn = infoLocal.off_btn;
			ret.on_yes = infoLocal.on_yes;
			ret.on_no = infoLocal.on_no;
			ret.on_atitle = infoLocal.on_atitle;
			ret.on_title = infoLocal.on_title;
