...
module.exports = function(gData){
	return {
		...
		loadInfo: function(section,callback){
			var _this = this;
			var inText = 'var bhelpSrvAddress="https://static.bhelp.com",bhelpInfoAddress="https://gb.bhelp.com", bhelpSrvVersion=1,bhelpSrvId='+section+';';//+_this.gData.sections[section].version+";\n";
