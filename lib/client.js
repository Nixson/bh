	...
	return {
		...
		loadInfo: function(section,locale,callback){
			...
			switch(ret.ps){
				...
				case 3: ret.lineStyle +='top: 50%; left: -1050px; width: 43px; height: 264px; margin-left: 0;'; break;
				...
				case 6: ret.lineStyle +='top: 50%; right: -1050px; width: 43px; height: 264px; margin-left: 0;'; break;
			}
			ret.lineStyle += '}';
