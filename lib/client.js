...
module.exports = function(gData){
	return {
		...
		fill: function(uid,info,firts){
			...
			console.log("info.path.headers.geoip_latitude",info.path.headers.geoip_latitude, typeof info.path.headers.geoip_latitude);
//			if(typeof info.path.headers.geoip_latitude)
