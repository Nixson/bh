...
var clientBlank = '{	 uid: 0	,sid: 0	,connection: 0	,triggers:[]	,cname: ""	,name: ""	,cphone: ""	,phone: ""	,cemail: ""	,email: ""	,ccomment: ""	,mcomment: ""	,chat: 0	,visits: 0	,chash: ""	,region: ""	,domain: ""	,ip: ""	,protocol: ""	,country_name: ""	,country_code: ""	,region: ""	,city: ""	,maps: ""	,agent: ""	,browser: ""	,url: ""	,title: ""	,os: ""	,ref: ""	,refSearch: ""	,mid: 0	,time: 0	,timeIn: 0	,numPage: 0	,find: false	,last: []	,tags: []	,online: false}';
	...
	return {
		...
		generateUser: function(info, callback){
			...
			_this.genUUID(function(uid){
				...
				_this.gData.clients[uid] = JSON.parse(clientBlank);
		...
		getManager: function(uid,sid,info,callback){
			...
			console.log('getManager',uid,sid,position,managers);
			var Call = {};
			Call.uid = uid;
			var mList = [];
			...
			for(var muidInfo in _this.gData.managers){
				console.log('getManager',muidInfo, typeof muidInfo,_this.gData.managers[muidInfo].id,_this.gData.managers[muidInfo].mList);
			}
			console.log('getManager',Manager.id);
			...
			if(typeof _this.gData.msgof[uid] == 'undefined') {
				...
				_this.gData.mysql.getConnection(function(err,connection){
					connection.query( 'select offmsg from bh_customer where uid = ?',[uid], function(err, rows) {
						...
						if(typeof rows!='undefined' && typeof rows[0]!='undefined'){
							if(rows[0].offmsg!=''){
								_this.gData.msgof[uid] = JSON.parse(rows[0].offmsg);
							}
						}
						if( typeof callback == 'function') callback();
					});
