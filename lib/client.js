...
module.exports = function(gData){
	return {
		...
		loadStatic: function(section,callback){
			...
			inText += ' bhelpSrvAddress="https://static.bhelp.com",bhelpInfoAddress="https://gb.bhelp.com",bhelpSignalAddress="https://fr.bhelp.com", bhelpSrvVersion='+_this.gData.sections[section].version+',bhelpSrvId='+section+',bhelpVer='+_this.gData.config.version+';\n';//+_this.gData.sections[section].version+";\n";
