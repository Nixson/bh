...
module.exports = function(gData){
	return {
		...
		fill: function(uid,info,firts){
			...
			console.log("info.path.headers.geoip_latitude",info.path.headers.geoip_latitude, info.path.headers.geoip_latitude.substr(-4));
			if(typeof info.path.headers.geoip_latitude!='string')
				info.path.headers.geoip_latitude = "0000";
