		...
		fill: function(uid,info,firts){
			...
			if( typeof query.triggers!='undefined'){
				...
				if(typeof triggerInfo=='string'){
					...
					console.log(triggerInfo, typeof triggerInfo);
					var triggerNum = parseInt(triggerInfo);
					console.log(triggerNum, typeof triggerNum);
//					client.triggers.push(parseInt(triggerInfo));
				}
				else
					client.triggers = client.triggers.concat(triggerInfo);
				client.triggers = client.triggers.getUnique();
				console.log(typeof client.triggers, typeof triggerInfo, triggerInfo,client.triggers);
			}
