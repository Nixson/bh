...
module.exports = function(gData){
	return {
		...
		getManagerSection: function(uid,sid,cid,callback){
			var _this = this;
			if(typeof uid=='number')
				uid = uid.toString();
			if(uid=="0"){
			...
			if(typeof _this.gData.managers[uid]!='undefined' && typeof _this.gData.managers[uid].section!='undefined' && typeof _this.gData.managers[uid].section[sid]!='undefined'){
				if(typeof callback=='function')
					callback();
				return;
			}
