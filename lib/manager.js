...
module.exports = function(gData){
	return {
		...
		send: function(uid, msg){
			...
			console.log("send",_this.gData.managers[uid].connection,_this.responseText[uid]);
