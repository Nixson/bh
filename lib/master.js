		...
		handler: function(msg,id){
			...
			if(typeof msg.client != 'undefined' && msg.client.uid > 0){
				switch(msg.client.type){
					case "in":
						var newCl = false;
						if(typeof gData.clients[msg.client.uid] == 'undefined') {
							newCl = true;
							gData.clients[msg.client.uid] = {};
						}
						if(typeof gData.clients[msg.client.uid][msg.client.cluster] == 'undefined') {
							gData.clients[msg.client.uid][msg.client.cluster] = 0;
						}
						gData.clients[msg.client.uid][msg.client.cluster]++;
						if(newCl)
							cluster.workers[msg.client.cluster].send({action:"userIn",type:"client",uid:msg.client.uid});
						break;
					case "exit":
					...
					case "clear":
						if(typeof gData.clients[msg.client.uid] !='undefined' && Object.keys(gData.clients[msg.client.uid]).length==0){
							...
							cluster.workers[msg.client.cluster].send({action:"clear",type:"client",uid:msg.client.uid,cid:msg.client.cid});
						}
						break;
					case "cmd":
			...
			if(typeof msg.manager != 'undefined' && msg.manager.uid > 0){
				switch(msg.manager.type){
					case "in":
						...
						break;
					case "exit":
						if(typeof gData.managers[msg.manager.uid] !="undefined" && typeof gData.managers[msg.manager.uid][msg.manager.cluster] != 'undefined') {
							gData.managers[msg.manager.uid][msg.manager.cluster]--;
						...
						break;
					case "clear":
						if(typeof gData.managers[msg.manager.uid] !='undefined')
							console.log(typeof gData.managers[msg.manager.uid],Object.keys(gData.managers[msg.manager.uid]).length);
						else
							console.log(typeof gData.managers[msg.manager.uid],0);
						if(typeof gData.managers[msg.manager.uid] !='undefined' && Object.keys(gData.managers[msg.manager.uid]).length==0){
							...
							console.log('send',msg.manager.cluster,{action:"clear",type:"manager",uid:msg.manager.uid,cid:msg.manager.cid});
