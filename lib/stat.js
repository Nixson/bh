...
module.exports = function(gData){
	return {
		...
		get: function(section,callback){
			...
			if(typeof _this.gData.log[section]=="undefined" && self.gData.log.managers[section]=='undefined'){
				...
				if(self.gData.log.managers[section]!='undefined'){
					...
					console.log(self.gData.log.managers[section]);
					for(var manager in self.gData.log.managers[section]){
						var appIn = 0;
						var appOut = 0;
						var appInNow = 0;
		...
		manager: function(sc,section,manager){
			var self = this;
			console.log(manager,sc,this.gData.time());
			...
			console.log(self.gData.log.managers[section][manager]);
		},
